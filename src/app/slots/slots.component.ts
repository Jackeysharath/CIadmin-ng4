...
export class SlotsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._api.POST('GetAvailableDates', {token: 'SomeTokenHere','test_id':this.test_id}).subscribe(data =>{
  ...
  getSlots(date:any){
    ...
    this._api.POST('GetAvailableTimeSlots', {token: 'SomeTokenHere','test_id':this.test_id,'date':date,'center_id':'1'}).subscribe(data =>{
